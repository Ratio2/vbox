...
#ifndef VBOX_INCLUDED_SRC_Puel_UsbCardReader_vusbcardreader_h
#define VBOX_INCLUDED_SRC_Puel_UsbCardReader_vusbcardreader_h
...
#endif /* !VBOX_INCLUDED_SRC_Puel_UsbCardReader_vusbcardreader_h */
