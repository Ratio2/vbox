...
#define Bs3SelLnkCodePtrToCurPtr BS3_CMN_MANGLER(Bs3SelLnkCodePtrToCurPtr)
...
#define Bs3SelRealModeCodeToProtFar16 BS3_CMN_MANGLER(Bs3SelRealModeCodeToProtFar16)
